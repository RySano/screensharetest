...
class ReplayKitVideoSource: NSObject, VideoSource {
    ...
    //static let kDownScaledMaxWidthOrHeight = UInt(500)
    //static let kDownScaledMaxWidthOrHeight = UInt(600)
    //static let kDownScaledMaxWidthOrHeight = UInt(700)
    //static let kDownScaledMaxWidthOrHeight = UInt(800)
    //static let kDownScaledMaxWidthOrHeight = UInt(750)
    //static let kDownScaledMaxWidthOrHeight = UInt(725)
    static let kDownScaledMaxWidthOrHeight = UInt(718)
