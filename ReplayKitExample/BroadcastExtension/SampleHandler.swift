...
class SampleHandler: RPBroadcastSampleHandler {
    ...
    //sano
    let tokenUrl = "https://telemagenta-eland-8513.twil.io/video-token"
    //kishida
    ...
    init(sampleBuffer: CMSampleBuffer) {
        print("CMSampleTimingInfoを保存しておく。")
    ...
    private func generateCVPixelBuffer(from ciImage: CIImage) -> CVPixelBuffer? {
        ...
        CVPixelBufferLockBaseAddress(pixelBuffer, CVPixelBufferLockFlags(rawValue: 10))
